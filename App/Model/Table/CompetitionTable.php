...
class CompetitionTable extends Table
{
    ...
    public function all()
    {
        ...
        c.id ID, c.name_compet, c.link_compet, c.level, c.info_manager, c.detail, c.picture, c.picture2, c.date dt, c.time, 
        l.id, l.title, l.percentage, l.color, l.stars, l.number_stars,
         m.id Id, m.name, m.email, m.number_phone, m.sex, m.nationality, m.year_b, m.date
        FROM competition c,
          level_competition  l,
           manager  m 
