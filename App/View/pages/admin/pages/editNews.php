...
<main class="main-content  mt-0">
  ...
  <form method="post" action="">
                    ...
                    <div class="mb-3">
                        <textarea rows="" cols="" value="contenus" name="content" class="form-control form-control-lg" placeholder="Contenus" value="<?=$find->content;?>" >
                        <?=htmlspecialchars($find->content);?>
                        </textarea>
