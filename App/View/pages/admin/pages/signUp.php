      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">votre inscription est autoriser par l'Admin <b><?= $user->username;?></b> </p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <form method="post" action="" enctype="multipart/form-data"  role="form">
                <div class="mb-3">
                  <input type="text" name="username" class="form-control" placeholder="Votre Nom" aria-label="Name">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <input type="password"  name="password2"  class="form-control" placeholder="Confirmer le mot de passe" aria-label="Password">
                </div>
                <div class="form-check form-check-info text-start">
                  <input class="form-check-input" name="valid" type="checkbox" value="valid" id="flexCheckDefault"  required>
                  <label class="form-check-label" name="valid" for="flexCheckDefault">
                ...
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="?src=login" class="text-dark font-weight-bolder">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
